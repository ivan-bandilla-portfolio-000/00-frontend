    ...
    <div className="flex items-center justify-center">
      {href ? (
        <a href={href}>
          ...
          >
            <div className="border border-[#3B3A3A] bg-primary  h-[43px] rounded-full flex items-center justify-center text-foreground">
              <p className="font-medium tracking-tight mr-3 ml-2 flex items-center gap-2 justify-center ">
                {children}
              </p>
            </div>
            <div className="text-amber-50 group-hover:ml-2  ease-in-out transition-all size-[26px] flex items-center justify-center rounded-full border-2 border-[#3b3a3a]  ">
              <ArrowRight
                size={18}
                className={
        ...
        >
          <div className="border border-[#3B3A3A] bg-primary  h-[43px] rounded-full flex items-center justify-center text-white">
