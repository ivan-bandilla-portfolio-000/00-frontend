...
const Hyperspeed = forwardRef(({ effectOptions = {} }: HyperspeedProps, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    setLocked: (locked: boolean) => {
      if (appRef.current) {
        appRef.current.setLocked(locked);
      }
    }
  }));
  ...
  return <div id="lights" className="w-full h-full absolute" ref={hyperspeed}></div>;
});
